...
from myODM.shots import get_geojson_shots_from_opensfm
from myODM.osfm import OSFMContext
from myODM import gsd
from myODM.point_cloud import export_info_json
from myODM.cropper import Cropper
from myODM.orthophoto import get_orthophoto_vars, get_max_memory, generate_png
from myODM.tiles.tiler import generate_colored_hillshade
from myODM.utils import get_raster_stats, np_from_json
...
def generate_point_cloud_stats(input_point_cloud, pc_info_file, rerun=False):
    try:
        ...
        log.ODM_WARNING("Cannot generate point cloud stats: %s" % str(e))
        return {}
            ...
            if os.path.exists(osfm_stats_json):
                ...
                if os.path.exists(tree.odm_georeferencing_model_laz):
                    ...
                    try:
                        ...
                        log.ODM_WARNING("Point cloud stats failed: %s" % str(e))
