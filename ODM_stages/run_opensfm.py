...
from myODM import point_cloud
from myODM import types
from myODM.utils import get_depthmap_resolution
from myODM.osfm import OSFMContext
from myODM import multispectral
from myODM import thermal
from myODM import nvm
from myODM.photo import find_largest_photo

from myOSfM.undistort import add_image_format_extension

class ODMOpenSfMStage(types.ODM_Stage):
    def process(self, args, outputs):
        print("This is process of OpenSfM stage (The most important stage of the whole pipeline)")
        tree = outputs['tree']
        ...
        print('I am before the photos to metadata function')
        octx.photos_to_metadata(photos, args.rolling_shutter, args.rolling_shutter_readout, self.rerun())
        print('I am before the update progress function')
        self.update_progress(20)
        
        print(self.rerun())

        print("I am before the feature matching function")
        octx.feature_matching(self.rerun())

        print("I finish feature matching")
        
        self.update_progress(30)

        print("I finish update progress")
