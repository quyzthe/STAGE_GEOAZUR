...
from myODM.rollingshutter import get_rolling_shutter_readout
import xmltodict as x2d
from myODM import get_image_size
from xml.parsers.expat import ExpatError
from myOSfM.sensors import sensor_data
from myOSfM.geo import ecef_from_lla
...
class ODM_Photo:
    ...
    # def camera_id(self):
    #     print("I am the function camera_id")
    #     return " ".join(
    #             [
    #                 "v2",
    ...
    def camera_id(self):
        print("DEBUG camera_id:")
        print("make:", self.camera_make)
        print("model:", self.camera_model)
        print("width:", self.width)
        print("height:", self.height)
        print("projection:", self.camera_projection)
        print("focal_ratio:", self.focal_ratio)
