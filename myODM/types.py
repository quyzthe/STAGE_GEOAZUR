...
from myODM.progress import progressbc
...
class ODM_Stage:
    ...
    def run(self, outputs = {}):
        print("Running stage: %s" % self.name)
        ...
        # Run next stage?
            ...
            print("[Regard Regard Regard!!!] im about to run next stage: %s" % self.next_stage.name)
    ...
    def update_progress(self, progress):
        print('I am in the update progress function')
