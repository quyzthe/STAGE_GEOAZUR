...
import numpy
import myOSfM.stub_files.pygeo
import myOSfM.stub_files.pygeometry
...
class BiasView:
    ...
    def __getitem__(self, arg0: str) -> myOSfM.pygeometry.Similarity: ...
    def __init__(self, arg0: Map) -> None: ...
    def __iter__(self) -> Iterator: ...
    def __len__(self) -> int: ...
    def get(self, arg0: str) -> myOSfM.pygeometry.Similarity: ...
...
class CameraView:
    def __contains__(self, arg0: str) -> bool: ...
    def __getitem__(self, arg0: str) -> myOSfM.pygeometry.Camera: ...
    def __init__(self, arg0: Map) -> None: ...
    def __iter__(self) -> Iterator: ...
    def __len__(self) -> int: ...
    def get(self, arg0: str) -> myOSfM.pygeometry.Camera: ...
    def items(self) -> Iterator: ...
    def keys(self) -> Iterator: ...
    def values(self) -> Iterator: ...

class Depth:
    def __init__(self, value: float, is_radial: bool, std_deviation: float) -> None: ...
    @property
...
class Map:
    ...
    def create_camera(
        self, camera: myOSfM.pygeometry.Camera
    ) -> myOSfM.pygeometry.Camera: ...
    def create_landmark(
        self, lm_id: str, global_position: numpy.ndarray
    ) -> Landmark: ...
    def create_pano_shot(
        self, arg0: str, arg1: str, arg2: str, arg3: str, arg4: myOSfM.pygeometry.Pose
    ) -> Shot: ...
    ...
    def get_bias(self, arg0: str) -> myOSfM.pygeometry.Similarity: ...
    def get_biases(self) -> BiasView: ...
    def get_camera(self, arg0: str) -> myOSfM.pygeometry.Camera: ...
    ...
    def get_reference(self) -> myOSfM.pygeo.TopocentricConverter: ...
    ...
    def set_bias(self, arg0: str, arg1: myOSfM.pygeometry.Similarity) -> None: ...
...
class RigCamera:
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, arg0: myOSfM.pygeometry.Pose, arg1: str) -> None: ...
    ...
    def id(self, arg0: str) -> None: ...
    @property
    def pose(self) -> myOSfM.pygeometry.Pose: ...
    @pose.setter
    def pose(self, arg0: myOSfM.pygeometry.Pose) -> None: ...
...
class RigInstance:
    ...
    def update_instance_pose_with_shot(
        self, arg0: str, arg1: myOSfM.pygeometry.Pose
    ) -> None: ...
    ...
    def pose(self) -> myOSfM.pygeometry.Pose: ...
    @pose.setter
    def pose(self, arg1: myOSfM.pygeometry.Pose) -> None: ...
    @property
...
class Shot:
    def __init__(
        self, arg0: str, arg1: myOSfM.pygeometry.Camera, arg2: myOSfM.pygeometry.Pose
    ) -> None: ...
    ...
    @property
    def camera(self) -> myOSfM.pygeometry.Camera: ...
    @property
