...
from myOSfM import context, features, geo, types
...
def rig_cameras_from_json(obj: Dict[str, Any]):
    """
...
def rig_instance_from_json(
    reconstruction, instance_id, obj
):
    """
...
def rig_instance_camera_per_shot(obj) :
    """
...
def read_ground_control_points(fileobj):
...
def ply_header(
    count_vertices, with_normals = False, point_num_views = False
):
    if with_normals:
        header = [
            "ply",
