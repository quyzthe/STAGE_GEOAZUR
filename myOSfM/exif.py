...
from myOSfM import pygeometry
from myOSfM.dataset_base import DataSetBase
from myOSfM.geo import ecef_from_lla
from myOSfM.sensors import camera_calibration, sensor_data
...
def camera_from_exif_metadata(
    ...
    # print(f"Check calibration projection type: {calib_pt}")
    ...
    if calib_pt == "perspective":
        ...
        print(f"Check camera projection type: {camera.projection_type}")
